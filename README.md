...
It is the companion code for *"Vehicle Data Normalization with Retrieval-Augmented LLMs"* (CLEI 2026). To reproduce the paper's evaluation and ablations, see [CLEI2026.md](CLEI2026.md).

## Method

Normalization is a mapping `φ: free-text → X̃` over the product space of all attribute domains, run as a three-step pipeline:
